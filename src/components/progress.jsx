...
import {  selectOnProgressTasks} from '../Redux/taskSlice';
import Modals from './Form/Modal';

import Header from './Header';


function Progress({handleOpenModal,handleDeleteTask,isModalOpen,handleCloseModal,selectedTask,handleSubmit}) {
    const ProgressTask = useSelector(selectOnProgressTasks)
